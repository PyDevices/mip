...
| --- | --- | --- | --- |
| `pydevices` | 0.5.2 | Portable display, audio, event, and timing foundations for PyDevices | [PyDevices/pydevices @ v0.5.2](https://github.com/PyDevices/pydevices/releases/tag/v0.5.2) |
| `pydevices-desktop` | 0.5.2 | Complete PyDevices desktop stack and board configuration | [PyDevices/pydevices @ v0.5.2](https://github.com/PyDevices/pydevices/releases/tag/v0.5.2) |
