...
| --- | --- | --- | --- |
| `pydevices` | 0.4.0 | PyDevices pydevices | [PyDevices/pydevices @ v0.4.0](https://github.com/PyDevices/pydevices/releases/tag/v0.4.0) |
| `pydevices-desktop` | 0.4.0 | PyDevices pydevices-desktop | [PyDevices/pydevices @ v0.4.0](https://github.com/PyDevices/pydevices/releases/tag/v0.4.0) |
